...
//controller for the '/secret' page with json response
@Controller
@RequestMapping("/secret")
public class SecretControllerJson extends SecretController {

    //calls the constructor of the super class
    protected SecretControllerJson(SecretService secretService) {
        super(secretService);
    }
